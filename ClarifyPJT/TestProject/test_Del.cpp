...
TEST_F(DeleteTest, DeleteByEmployeeNumTest) {
	...
	InputParameter input = { Command::Command_Sch, Option1::Option1_None, Option2::Option2_None, Column::Column_employeeNum , deleteEmployee };
...
TEST_F(DeleteTest, DeleteByNameTest) {
	Employee deleteEmployee = { 12345678, {"±è", "Ã¶¼ö"}, CareerLevel::CareerLevel_2,  {1234, 8765}, {1990, 02, 01}, Certi::Certi_PRO };
	InputParameter input = { Command::Command_Sch, Option1::Option1_None, Option2::Option2_None, Column::Column_Name , deleteEmployee };
...
TEST_F(DeleteTest, DeleteByCareerLevelTest) {
	...
	InputParameter input = { Command::Command_Sch, Option1::Option1_None, Option2::Option2_None, Column::Column_CareerLevel , deleteEmployee };
...
TEST_F(DeleteTest, DeleteByPhoneNumTest) {
	Employee deleteEmployee = { 11111111, {"È«", "±æµ¿"}, CareerLevel::CareerLevel_1,  {9513, 7412}, {1990, 04, 03}, Certi::Certi_PRO };
	InputParameter input = { Command::Command_Sch, Option1::Option1_None, Option2::Option2_None, Column::Column_PhoneNum , deleteEmployee };
...
TEST_F(DeleteTest, DeleteByBirthDayTest) {
	...
	InputParameter input = { Command::Command_Sch, Option1::Option1_None, Option2::Option2_None, Column::Column_BirthDay , deleteEmployee };
...
TEST_F(DeleteTest, DeleteByCertiTest) {
	Employee deleteEmployee = { 87654321, {"°í", "±æµ¿"}, CareerLevel::CareerLevel_4,  {1354, 9516}, {1990, 03, 02}, Certi::Certi_ADV };
	InputParameter input = { Command::Command_Sch, Option1::Option1_None, Option2::Option2_None, Column::Column_Certi , deleteEmployee };
