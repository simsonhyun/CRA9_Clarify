...
TEST(BasicModTest, NotOptionNotDupliModifyData) {
	...
	ASSERT_TRUE(mod.ModNotOption1(inputParameter).size()==1);
...
TEST(BasicModTest, NotOptionDupliModifyData) {
	...
	ASSERT_TRUE(mod.ModNotOption1(inputParameter).size() == 2);
...
TEST(BasicModTest, Option1DupliModifyData) {
	...
	InputParameter inputParameter = { Command::Command_Mod, Option1::Option1_p, Option2::Option2_None,
										Column::Column_Name, Column::Column_Certi,employee, employee3 };
	vector<Employee> resultOption1 = mod.ModOption1(inputParameter);
...
TEST(BasicModTest, Option1and2ModifyData) {
	...
	ASSERT_TRUE(mod.ModOption1(inputParameter).size() == 5);
