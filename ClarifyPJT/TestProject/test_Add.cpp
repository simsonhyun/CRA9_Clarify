...
TEST(TEST_ADD_MODULE, ADD_TEST) {
	...
	birthday._month = 01;
	birthday._day = 23;
	Employee employee(12345678, Name("길동", "홍"), CareerLevel::CareerLevel_2, phonenum, birthday, Certi::Certi_PRO);
...
TEST(TEST_ADD_MODULE, ADD_MAX_SIZE_TEST) {
	...
	{
		Employee inputemployee(employeeNum, Name("길동", "홍"), CareerLevel::CareerLevel_2, phonenum, birthday, Certi::Certi_PRO);
