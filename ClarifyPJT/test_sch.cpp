...
protected:
	void SetUp() override {
		Employee employee1 = { 12345678, "È« ±æµ¿", CareerLevel_1,  {1234, 5678}, {1990, 01, 01}, Certi_ADV };
		Employee employee2 = { 87654321, "±è Ã¶¼ö", CareerLevel_2,  {1234, 8765}, {1990, 02, 01}, Certi_PRO };
		Employee employee3 = { 12345678, "ÀÌ ¿µÈñ", CareerLevel_3,  {9876, 5678}, {1990, 01, 02}, Certi_EX };
		Employee employee4 = { 87654321, "°í ±æµ¿", CareerLevel_4,  {1354, 9516}, {1990, 03, 02}, Certi_ADV };
		Employee employee5 = { 11111111, "È« ±æµ¿", CareerLevel_1,  {9513, 7412}, {1990, 04, 03}, Certi_PRO };
...
TEST_F(SearchTest, SearchByEmployeeNumTest) {
	Employee searchEmployee = { 12345678, "±è Ã¶¼ö", CareerLevel_2,  {1234, 8765}, {1990, 02, 01}, Certi_PRO };
...
TEST_F(SearchTest, SearchByCareerLevelTest) {
	Employee searchEmployee = { 11111111, "È« ±æµ¿", CareerLevel_1,  {9513, 7412}, {1990, 04, 03}, Certi_PRO };
...
TEST_F(SearchTest, SearchByCertiTest) {
	Employee searchEmployee = { 87654321, "°í ±æµ¿", CareerLevel_4,  {1354, 9516}, {1990, 03, 02}, Certi_ADV };
